...
def show_menu_frame():
    ...
    menu_play_btn = Button(menu_bottom_frame,
                           width=10,
                           height=1,
                           bg="#36A4FF",
                           fg="white",
    ...
    menu_ai_btn = Button(menu_bottom_frame,
                         width=10,
                         height=1,
                         bg="#36A4FF",
                         fg="white",
...
def show_difficulty_frame():
    ...
    difficulty_easy = Button(difficulty_bottom_frame,
                             width=10,
                             height=1,
                             bg="#36A4FF",
                             fg="white",
    ...
    difficulty_medium = Button(difficulty_bottom_frame,
                               width=10,
                               height=1,
                               bg="#36A4FF",
                               fg="white",
    ...
    difficulty_hard = Button(difficulty_bottom_frame,
                             width=10,
                             height=1,
                             bg="#36A4FF",
                             fg="white",
...
def show_ai_frame():
    ...
    ai_step_btn = Button(minesweeper_top_frame,
                         width=12,
                         height=1,
                         bg="#36A4FF",
                         fg="white",
    ...
    ai_quit_btn = Button(minesweeper_top_frame,
                         width=12,
                         height=1,
                         bg="#36A4FF",
                         fg="white",
...
def show_minesweeper_frame(size):
    ...
    Cell.create_cell_count_label(minesweeper_top_frame)
    minesweeper_quit_btn = Button(minesweeper_top_frame,
                                  width=12,
                                  height=1,
                                  bg="#36A4FF",
                                  fg="white",
